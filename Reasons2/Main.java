...
//Difference between Iterable and Iterator :
                Iterable(I)
                  Iterable :
                In Java an Interface called "Iterable" is present and contains the method iterable.
                We implement this interface when we want to use a loop like the one we want for our generic tree.
                It has only a function declared in its body which returns an object of type Iterator and the name of the function is "iterator()". 
                It doesn't take any parameters.
                   Iterator:(Functions or Methods)
